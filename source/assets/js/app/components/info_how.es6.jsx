const InfoHow = (props) => {
  return (
    <div className="container">
      <div id="how-it-works">
        <p>
          <strong>palava.tv</strong> enables video communication with your friends and colleagues from within your web browser! No registration is required and you don't need to install any browser plugins!
        </p>
        ...
        <p>
          <strong>palava.tv</strong> is based on a new technology called <a href="http://www.webrtc.org/">Web Real-Time Communication</a> (WebRTC), which enables pluginless video conferencing via peer-to-peer connections. Please see our <a href="https://blog.palava.tv/">blog</a> or our <a href="https://github.com/palavatv/">github page</a> for more technical information!
        </p>
      </div>
